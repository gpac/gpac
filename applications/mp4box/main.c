...
void PrintImportUsage()
{
	fprintf(stderr, "Importing Options\n"
	        ...
	        " \":tc=VAL\"            injects a single QT timecode. VAL can be preceeded with \"f\" to enable ffmpeg compatibility. VAL is formated as:\n"
	        ...
	        "                         The drop flag is used to indicate that the counter is in drop-frame format"
	        "\n"
