...
public class SensorServices implements SensorEventListener, GPACInstanceInterface {
    ...
    public SensorServices(Context context){
        ...
        if(magnetometer==null || accelerometer == null) Log.e(LOG_TAG, "No Accelerometer and/or Magnetic Field sensors found"); //TODOk handle this - rollback to manual navigation
