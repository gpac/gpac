...
typedef struct {
	...
	u8 dv_md_compression; //2 bits
	u8 dv_feature_flags[10]; // 10 bits
	//const unsigned int (16) unused_2 = 0;
	//const unsigned int (32)[4] unused_3 = 0;
...
} GF_AC4BedChannelAssignment;

typedef struct {
	/* common attribute in AC4 DSI */
	...
	u8 n_objects_code;
	GF_AC4BedChannelAssignment bed_obj;
	// substream_info_ajoc
	GF_AC4BedChannelAssignment d_bed_dyn_obj;
	GF_AC4BedChannelAssignment u_bed_dyn_obj;
	// ac4_substream_info_chan
	u32 ch_mode;
	u32 channel_mode;
	// ac4_substream_info_obj & substream_info_ajoc
	u32 n_objs;
	u32 obj_types[GF_AC4_MAX_NUM_OBJECTS];
	u32 b_lfes[GF_AC4_MAX_NUM_OBJECTS];
	u32 b_ajoc_codeds[GF_AC4_MAX_NUM_OBJECTS];
	// ac4_substream_info_obj & substream_info_ajoc & ac4_substream_info_chan
	u8 b_audio_ndot;
	u8 b_lfe;
	u32 other_objs;
	u8 sus_ver;
	...
	// oamd_substream_info
	u8 b_oamd_ndot;
	// emdf_payloads_substream -> dialog_enhancement_info
