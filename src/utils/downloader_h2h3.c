...
static GF_DownloadSession *hmux_get_session(void *user_data, s32 stream_id, Bool can_reassign)
{
	u32 i, nb_sess;
...
#ifdef GPAC_HAS_HTTP2
		gf_assert( ((nghttp2_data_provider *)first_not_assigned->hmux_priv)->source.ptr);
#endif
