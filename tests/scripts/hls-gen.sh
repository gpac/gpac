...
do_hash_test "file.m3u8" "hls-master"
do_hash_test "file_1.m3u8" "hls-pl1"
do_hash_test "file_2.m3u8" "hls-pl2"

do_hash_test "test-1-.mp4" "hls-init1"
do_hash_test "test-2-.mp4" "hls-init2"

do_hash_test "test-1-10.m4s" "hls-seg1_10"
do_hash_test "test-2-10.m4s" "hls-seg2_10"
