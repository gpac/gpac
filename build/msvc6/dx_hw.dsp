...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../../include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "DX_HW_EXPORTS" /YX /FD /c
...
# ADD LINK32 opengl32.lib glu32.lib dsound.lib dxguid.lib ddraw.lib ole32.lib user32.lib gdi32.lib /nologo /dll /machine:I386 /out:"../../bin/w32_rel/dx_hw.dll"
...
# ADD LINK32 opengl32.lib dsound.lib dxguid.lib ddraw.lib ole32.lib user32.lib gdi32.lib /nologo /dll /debug /machine:I386 /out:"../../bin/w32_deb/dx_hw.dll" /pdbtype:sept /libpath:"../../extra_lib/lib/w32_deb"
