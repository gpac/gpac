...
static const GF_FilterArgs RTPInArgs[] =
{
	...
	{ OFFS(reorder_len), "RTP reorder length in packets", GF_PROP_UINT, "100", NULL, GF_FALSE},
	{ OFFS(reorder_delay), "Max delay in RTP reorderer, packets will be dispatched after that", GF_PROP_UINT, "200", NULL, GF_FALSE},
	{ OFFS(block_size), "buffer size fur RTP/UDP or RTSP when interleaved", GF_PROP_UINT, "0x100000", NULL, GF_FALSE},
