...
s32 gf_lsr_anim_type_from_attribute(u32 tag) {
	...
	case TAG_SVG_ATT_handler: return 36;
	...
	case TAG_SVG_ATT_listener_target: return 43;
	...
	case TAG_SVG_ATT_observer: return 58;
...
s32 gf_lsr_anim_type_to_attribute(u32 tag) {
	...
	case 43: return TAG_SVG_ATT_listener_target;
	...
	case 58: return TAG_SVG_ATT_observer;
