...
/*
	DO NOT MOFIFY - File generated on GMT Fri Sep 15 09:05:10 2006
...
typedef struct _tagX3DEspduTransform
{
	...
	void (*on_set_articulationParameterValue0)(GF_Node *pThis);	/*eventInHandler*/
	SFFloat set_articulationParameterValue1;	/*eventIn*/
	void (*on_set_articulationParameterValue1)(GF_Node *pThis);	/*eventInHandler*/
	SFFloat set_articulationParameterValue2;	/*eventIn*/
	void (*on_set_articulationParameterValue2)(GF_Node *pThis);	/*eventInHandler*/
	SFFloat set_articulationParameterValue3;	/*eventIn*/
	void (*on_set_articulationParameterValue3)(GF_Node *pThis);	/*eventInHandler*/
	SFFloat set_articulationParameterValue4;	/*eventIn*/
	void (*on_set_articulationParameterValue4)(GF_Node *pThis);	/*eventInHandler*/
	SFFloat set_articulationParameterValue5;	/*eventIn*/
	void (*on_set_articulationParameterValue5)(GF_Node *pThis);	/*eventInHandler*/
	SFFloat set_articulationParameterValue6;	/*eventIn*/
	void (*on_set_articulationParameterValue6)(GF_Node *pThis);	/*eventInHandler*/
	SFFloat set_articulationParameterValue7;	/*eventIn*/
	void (*on_set_articulationParameterValue7)(GF_Node *pThis);	/*eventInHandler*/
...
typedef struct _tagX3DGeoLOD
{
	...
	SFFloat range;	/*field*/
	MFURL rootUrl;	/*field*/
	GF_List *rootNode;	/*field*/
	GF_List *children;	/*eventOut*/
	GF_Node *metadata;	/*exposedField*/
} X_GeoLOD;
...
typedef struct _tagX3DGeoViewpoint
{
	...
	void (*on_set_position)(GF_Node *pThis);	/*eventInHandler*/
	SFString description;	/*exposedField*/
...
typedef struct _tagX3DHAnimHumanoid
{
	...
	GF_List *joints;	/*exposedField*/
	SFString name;	/*exposedField*/
	SFRotation rotation;	/*exposedField*/
	SFVec3f scale;	/*exposedField*/
	SFRotation scaleOrientation;	/*exposedField*/
	GF_List *segments;	/*exposedField*/
	GF_List *sites;	/*exposedField*/
	GF_List *skeleton;	/*exposedField*/
	GF_List *skin;	/*exposedField*/
	GF_Node *skinCoord;	/*exposedField*/
	GF_Node *skinNormal;	/*exposedField*/
	SFVec3f translation;	/*exposedField*/
	SFString version;	/*exposedField*/
	GF_List *viewpoints;	/*exposedField*/
	GF_Node *metadata;	/*exposedField*/
} X_HAnimHumanoid;
...
typedef struct _tagX3DHAnimJoint
{
	...
	VRML_CHILDREN
	SFVec3f center;	/*exposedField*/
	GF_List *displacers;	/*exposedField*/
...
typedef struct _tagX3DLoadSensor
{
	...
	GF_List *watchList;	/*exposedField*/
	SFBool isActive;	/*eventOut*/
...
{
	BASE_NODE
	GF_List *addGeometry;	/*eventIn*/
	void (*on_addGeometry)(GF_Node *pThis);	/*eventInHandler*/
	GF_List *removeGeometry;	/*eventIn*/
	void (*on_removeGeometry)(GF_Node *pThis);	/*eventInHandler*/
	GF_List *geometry;	/*exposedField*/
...
{
	BASE_NODE
	GF_List *addTrimmingContour;	/*eventIn*/
	void (*on_addTrimmingContour)(GF_Node *pThis);	/*eventInHandler*/
	GF_List *removeTrimmingContour;	/*eventIn*/
	void (*on_removeTrimmingContour)(GF_Node *pThis);	/*eventInHandler*/
	GF_List *trimmingContour;	/*exposedField*/
	GF_Node *controlPoint;	/*exposedField*/
	GF_Node *texCoord;	/*exposedField*/
	SFInt32 uTessellation;	/*exposedField*/
	SFInt32 vTessellation;	/*exposedField*/
