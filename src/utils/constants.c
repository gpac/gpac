...
CodecIDReg CodecRegistry [] = {
	...
	{GF_CODECID_MPEG2_PART3, GF_CODECID_MPEG2_PART3, GF_STREAM_AUDIO, "MPEG-1/2 Audio Layer 2", "mp2|m2a", ".mp2", "audio/mpeg"},
	{GF_CODECID_MPEG_AUDIO_L1, GF_CODECID_MPEG_AUDIO, GF_STREAM_AUDIO, "MPEG-1 Audio Layer 1", "mp1", ".mp1", "audio/mpeg"},
