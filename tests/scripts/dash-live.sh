...
do_test "$MP4BOX -add $EXTERNAL_MEDIA_DIR/counter/counter-30s_I25_baseline_1280x720_512kbps.264:dur=5 -add $EXTERNAL_MEDIA_DIR/counter/counter-30s_audio.aac:dur=5 -new $TEMP_DIR/file.mp4" "dash-input-preparation"
