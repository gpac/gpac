...
#pragma comment (linker, EXPORT_SYMBOL(gf_atsc_dmx_process) )
#pragma comment (linker, EXPORT_SYMBOL(gf_atsc_dmx_del) )
#pragma comment (linker, EXPORT_SYMBOL(gf_atsc_dmx_new) )
#pragma comment (linker, EXPORT_SYMBOL(gf_atsc_tune_in) )
#pragma comment (linker, EXPORT_SYMBOL(gf_atsc_dmx_process_services) )
#pragma comment (linker, EXPORT_SYMBOL(gf_atsc_set_callback) )
