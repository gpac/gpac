...
#define GF_CAPS_INPUT	(GF_FILTER_CAPS_IN_BUNDLE|GF_FILTER_CAPS_INPUT|GF_FILTER_CAPS_STATIC)
#define GF_CAPS_INPUT_STATIC	(GF_FILTER_CAPS_IN_BUNDLE|GF_FILTER_CAPS_INPUT)
