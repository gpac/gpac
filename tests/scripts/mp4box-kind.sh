...
$MP4BOX -info $TEMP_DIR/out.mp4 2> /dev/null
$MP4BOX -diso $TEMP_DIR/out.mp4 2> /dev/null
...
$MP4BOX -kind mySecondKindScheme $TEMP_DIR/file.mp4 -out $TEMP_DIR/out.mp4  2> /dev/null
$MP4BOX -info $TEMP_DIR/out.mp4 2> /dev/null
do_test "$MP4BOX -add $TEMP_DIR/out.mp4 $TEMP_DIR/out2.mp4" "kind-import-mp4"
$MP4BOX -info $TEMP_DIR/out2.mp4 2> /dev/null
rm $TEMP_DIR/out2.mp4
