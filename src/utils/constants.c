...
CodecIDReg CodecRegistry [] = {
	...
	{GF_CODECID_HEIF, GF_CODECID_HEVC, GF_STREAM_VISUAL, "HEIF Image", "heif|heic", "hvc1|j2c", "image/heic", GF_CODECID_J2C},
	{GF_CODECID_AVIF, 0, GF_STREAM_VISUAL, "AVIF Image", "avif", NULL, "image/avif"},
	...
	{GF_CODECID_J2K, 0x6E, GF_STREAM_VISUAL, "JPEG 2000 Part 1", "jp2|j2k", "mj2|mjp2", "image/jp2"},
	{GF_CODECID_J2K, 0x6E, GF_STREAM_VISUAL, "JPEG 2000 Part 2", "jpf", "mj2|mjp2", "image/jpx"},
	{GF_CODECID_MJ2P, 0x6E, GF_STREAM_VISUAL, "Motion JPEG 2000 Part 3", "mj2|mjp2", "mj2|mjp2", "video/mj2"},
	{GF_CODECID_JPM, 0x6E, GF_STREAM_VISUAL, "PDF JPEG 2000 Part 6", "jpm", "mj2|mjp2", "image/jpm"},
	{GF_CODECID_J2C, 0x6E, GF_STREAM_VISUAL, "High-throughput JPEG 2000 Part 16", "j2c", "mj2c", "image/j2c"},
	{GF_CODECID_MJ2C, 0x6E, GF_STREAM_VISUAL, "Multi High-throughput JPEG 2000 Part 16", "mj2c", "mj2c", "video/j2c"},
