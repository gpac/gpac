...
GF_FilterRegister RewinderRegister = {
	.name = "rewind",
	.description = "Audio and video rewinder",
	.comment = "The filter is in passthrough if speed is positive. Otherwise, it reverts decoded GOPs for video, or revert samples in decoded frame for audio.",
