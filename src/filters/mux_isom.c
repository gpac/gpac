...
static const GF_FilterArgs MP4MuxArgs[] =
{
	...
	{ OFFS(msn), "Sets sequence number of first moof to N", GF_PROP_UINT, "1", NULL, GF_FALSE},
	{ OFFS(msninc), "Sets sequence number increase between moofs", GF_PROP_UINT, "1", NULL, GF_FALSE},
