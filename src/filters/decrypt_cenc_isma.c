...
static const GF_FilterCapability CENCDecInputs[] =
{
	CAP_INC_UINT(GF_PROP_PID_STREAM_TYPE, GF_STREAM_ENCRYPTED),
	CAP_EXC_UINT(GF_PROP_PID_UNFRAMED, GF_TRUE),
	CAP_INC_UINT(GF_PROP_PID_PROTECTION_SCHEME_TYPE, GF_ISOM_ISMACRYP_SCHEME),
	CAP_INC_UINT(GF_PROP_PID_PROTECTION_SCHEME_TYPE, GF_ISOM_OMADRM_SCHEME),
	CAP_INC_UINT(GF_PROP_PID_PROTECTION_SCHEME_TYPE, GF_ISOM_CENC_SCHEME),
	CAP_INC_UINT(GF_PROP_PID_PROTECTION_SCHEME_TYPE, GF_ISOM_CENS_SCHEME),
	CAP_INC_UINT(GF_PROP_PID_PROTECTION_SCHEME_TYPE, GF_ISOM_CBC_SCHEME),
	CAP_INC_UINT(GF_PROP_PID_PROTECTION_SCHEME_TYPE, GF_ISOM_CBCS_SCHEME),
};

static const GF_FilterCapability CENCDecOutputs[] =
{
	CAP_EXC_UINT(GF_PROP_PID_STREAM_TYPE, GF_STREAM_ENCRYPTED),
	CAP_EXC_UINT(GF_PROP_PID_OTI, GPAC_OTI_RAW_MEDIA_STREAM),
	CAP_INC_UINT(GF_PROP_PID_UNFRAMED, GF_FALSE),
};
...
GF_FilterRegister CENCDecRegister = {
	...
	INCAPS(CENCDecInputs),
	OUTCAPS(CENCDecOutputs),
