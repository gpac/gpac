...
static const struct xml_att_def { const char *name; u32 tag; u32 type; u32 opts; u32 xmlns; } xml_attributes [] = 
{
	...
	{ "requiredFeatures", TAG_SVG_ATT_requiredFeatures, SVG_ListOfIRI_datatype, 0, GF_XMLNS_SVG },
	{ "requiredExtensions", TAG_SVG_ATT_requiredExtensions, SVG_ListOfIRI_datatype, 0, GF_XMLNS_SVG },
	{ "requiredFormats", TAG_SVG_ATT_requiredFormats, SVG_FormatList_datatype, 0, GF_XMLNS_SVG },
	{ "requiredFonts", TAG_SVG_ATT_requiredFonts, SVG_FontList_datatype, 0, GF_XMLNS_SVG },
	{ "systemLanguage", TAG_SVG_ATT_systemLanguage, SVG_LanguageIDs_datatype, 0, GF_XMLNS_SVG },
	...
	{ "lang", TAG_SVG_ATT_lang, SVG_LanguageIDs_datatype, 0, GF_XMLNS_SVG },
