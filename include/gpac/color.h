...
typedef struct
{
	...
	/*!indicates U and V (and optional alpha) buffers in case of planar video with seperated component. If not set, all components are in the video_buffer pointer*/
