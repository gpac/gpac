...
#define ISOM_BOX_IMPL_DECL_W_TYPE(a_name) \
		GF_Box * a_name##_New(u32 type); \
		void a_name##_del(GF_Box *); \
		GF_Err a_name##_Read(GF_Box *s, GF_BitStream *bs); \
		GF_Err a_name##_Write(GF_Box *s, GF_BitStream *bs); \
		GF_Err a_name##_Size(GF_Box *s);\
...
ISOM_BOX_IMPL_DECL_W_TYPE(unkn)
...
ISOM_BOX_IMPL_DECL_W_TYPE(mpeg_video)
...
/*WebVTT boxes*/
ISOM_BOX_IMPL_DECL_W_TYPE(boxstring);
...
ISOM_BOX_IMPL_DECL_W_TYPE(trgt)
...
ISOM_BOX_IMPL_DECL_W_TYPE(grptype)
