...
static GF_Err gf_svg_circle_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 60:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGcircleElement *)node)->_class;
			return GF_OK;
		case 61:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_ellipse_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 60:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGellipseElement *)node)->_class;
			return GF_OK;
		case 61:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_line_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 60:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGlineElement *)node)->_class;
			return GF_OK;
		case 61:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_linearGradient_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 51:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGlinearGradientElement *)node)->_class;
			return GF_OK;
		case 52:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_path_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 61:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGpathElement *)node)->_class;
			return GF_OK;
		case 62:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_polygon_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 61:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGpolygonElement *)node)->_class;
			return GF_OK;
		case 62:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_polyline_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 61:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGpolylineElement *)node)->_class;
			return GF_OK;
		case 62:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_radialGradient_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 51:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGradialGradientElement *)node)->_class;
			return GF_OK;
		case 52:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
static GF_Err gf_svg_rect_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 60:
			info->name = "class";
			info->fieldType = SVG_String_datatype;
			info->far_ptr = & ((SVGrectElement *)node)->_class;
			return GF_OK;
		case 61:
			info->name = "xml:id";
			info->fieldType = SVG_ID_datatype;
...
u32 gf_svg_get_attribute_count(GF_Node *node)
{
	switch (node->sgprivate->tag) {
		...
		case TAG_SVG_animation: return 60;
		case TAG_SVG_audio: return 41;
		case TAG_SVG_circle: return 76;
		case TAG_SVG_defs: return 41;
		case TAG_SVG_desc: return 7;
		case TAG_SVG_discard: return 15;
		case TAG_SVG_ellipse: return 77;
		...
		case TAG_SVG_line: return 77;
		case TAG_SVG_linearGradient: return 60;
		...
		case TAG_SVG_path: return 75;
		case TAG_SVG_polygon: return 74;
		case TAG_SVG_polyline: return 74;
		case TAG_SVG_prefetch: return 19;
		case TAG_SVG_radialGradient: return 59;
		case TAG_SVG_rect: return 79;
