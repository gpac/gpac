...
static void gf_svg_conditional_del(GF_Node *node)
{
...
static GF_Err gf_svg_conditional_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		case 0:
			info->name = "id";
...
static void gf_svg_cursorManager_del(GF_Node *node)
{
	SVGcursorManagerElement *p = (SVGcursorManagerElement *)node;
	gf_svg_reset_base_element((SVGElement *)p);
	gf_sg_parent_reset((GF_Node *) p);
	gf_node_free((GF_Node *)p);
}

static GF_Err gf_svg_cursorManager_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		case 0:
			info->name = "id";
		...
		case 14:
			info->name = "x";
			info->fieldType = SVG_Length_datatype;
			info->far_ptr = & ((SVGcursorManagerElement *)node)->x;
			return GF_OK;
		case 15:
			info->name = "y";
			info->fieldType = SVG_Length_datatype;
			info->far_ptr = & ((SVGcursorManagerElement *)node)->y;
			return GF_OK;
		default: return GF_BAD_PARAM;
	}
}
...
static GF_Err gf_svg_listener_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		...
		case 14:
			info->name = "enabled";
			info->fieldType = SVG_Boolean_datatype;
			info->far_ptr = & ((SVGlistenerElement *)node)->enabled;
			return GF_OK;
		default: return GF_BAD_PARAM;
	}
}
...
static void gf_svg_rectClip_del(GF_Node *node)
{
...
static GF_Err gf_svg_rectClip_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		case 0:
			info->name = "id";
...
static void gf_svg_selector_del(GF_Node *node)
{
...
static GF_Err gf_svg_selector_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		case 0:
			info->name = "id";
...
static void gf_svg_simpleLayout_del(GF_Node *node)
{
...
static GF_Err gf_svg_simpleLayout_get_attribute(GF_Node *node, GF_FieldInfo *info)
{
	switch (info->fieldIndex) {
		case 0:
			info->name = "id";
...
{
	switch (ElementTag) {
		case TAG_SVG_a: return (SVGElement*) gf_svg_new_a();
		case TAG_SVG_animate: return (SVGElement*) gf_svg_new_animate();
		case TAG_SVG_animateColor: return (SVGElement*) gf_svg_new_animateColor();
		case TAG_SVG_animateMotion: return (SVGElement*) gf_svg_new_animateMotion();
		case TAG_SVG_animateTransform: return (SVGElement*) gf_svg_new_animateTransform();
		case TAG_SVG_animation: return (SVGElement*) gf_svg_new_animation();
		case TAG_SVG_audio: return (SVGElement*) gf_svg_new_audio();
		case TAG_SVG_circle: return (SVGElement*) gf_svg_new_circle();
		case TAG_SVG_conditional: return (SVGElement*) gf_svg_new_conditional();
		case TAG_SVG_cursorManager: return (SVGElement*) gf_svg_new_cursorManager();
		case TAG_SVG_defs: return (SVGElement*) gf_svg_new_defs();
		case TAG_SVG_desc: return (SVGElement*) gf_svg_new_desc();
		case TAG_SVG_discard: return (SVGElement*) gf_svg_new_discard();
		case TAG_SVG_ellipse: return (SVGElement*) gf_svg_new_ellipse();
		case TAG_SVG_font: return (SVGElement*) gf_svg_new_font();
		case TAG_SVG_font_face: return (SVGElement*) gf_svg_new_font_face();
		case TAG_SVG_font_face_src: return (SVGElement*) gf_svg_new_font_face_src();
		case TAG_SVG_font_face_uri: return (SVGElement*) gf_svg_new_font_face_uri();
		case TAG_SVG_foreignObject: return (SVGElement*) gf_svg_new_foreignObject();
		case TAG_SVG_g: return (SVGElement*) gf_svg_new_g();
		case TAG_SVG_glyph: return (SVGElement*) gf_svg_new_glyph();
		case TAG_SVG_handler: return (SVGElement*) gf_svg_new_handler();
		case TAG_SVG_hkern: return (SVGElement*) gf_svg_new_hkern();
		case TAG_SVG_image: return (SVGElement*) gf_svg_new_image();
		case TAG_SVG_line: return (SVGElement*) gf_svg_new_line();
		case TAG_SVG_linearGradient: return (SVGElement*) gf_svg_new_linearGradient();
		case TAG_SVG_listener: return (SVGElement*) gf_svg_new_listener();
		case TAG_SVG_metadata: return (SVGElement*) gf_svg_new_metadata();
		case TAG_SVG_missing_glyph: return (SVGElement*) gf_svg_new_missing_glyph();
		case TAG_SVG_mpath: return (SVGElement*) gf_svg_new_mpath();
		case TAG_SVG_path: return (SVGElement*) gf_svg_new_path();
		case TAG_SVG_polygon: return (SVGElement*) gf_svg_new_polygon();
		case TAG_SVG_polyline: return (SVGElement*) gf_svg_new_polyline();
		case TAG_SVG_prefetch: return (SVGElement*) gf_svg_new_prefetch();
		case TAG_SVG_radialGradient: return (SVGElement*) gf_svg_new_radialGradient();
		case TAG_SVG_rect: return (SVGElement*) gf_svg_new_rect();
		case TAG_SVG_rectClip: return (SVGElement*) gf_svg_new_rectClip();
		case TAG_SVG_script: return (SVGElement*) gf_svg_new_script();
		case TAG_SVG_selector: return (SVGElement*) gf_svg_new_selector();
		case TAG_SVG_set: return (SVGElement*) gf_svg_new_set();
		case TAG_SVG_simpleLayout: return (SVGElement*) gf_svg_new_simpleLayout();
		case TAG_SVG_solidColor: return (SVGElement*) gf_svg_new_solidColor();
		case TAG_SVG_stop: return (SVGElement*) gf_svg_new_stop();
		case TAG_SVG_svg: return (SVGElement*) gf_svg_new_svg();
		case TAG_SVG_switch: return (SVGElement*) gf_svg_new_switch();
		case TAG_SVG_tbreak: return (SVGElement*) gf_svg_new_tbreak();
		case TAG_SVG_text: return (SVGElement*) gf_svg_new_text();
		case TAG_SVG_textArea: return (SVGElement*) gf_svg_new_textArea();
		case TAG_SVG_title: return (SVGElement*) gf_svg_new_title();
		case TAG_SVG_tspan: return (SVGElement*) gf_svg_new_tspan();
		case TAG_SVG_use: return (SVGElement*) gf_svg_new_use();
		case TAG_SVG_video: return (SVGElement*) gf_svg_new_video();
		default: return NULL;
	}
}
...
void gf_svg_element_del(SVGElement *elt)
{
	...
	switch (node->sgprivate->tag) {
		...
		case TAG_SVG_conditional: gf_svg_conditional_del(node); return;
		case TAG_SVG_cursorManager: gf_svg_cursorManager_del(node); return;
		...
		case TAG_SVG_rectClip: gf_svg_rectClip_del(node); return;
		case TAG_SVG_script: gf_svg_script_del(node); return;
		case TAG_SVG_selector: gf_svg_selector_del(node); return;
		case TAG_SVG_set: gf_svg_set_del(node); return;
		case TAG_SVG_simpleLayout: gf_svg_simpleLayout_del(node); return;
...
GF_Err gf_svg_get_attribute_info(GF_Node *node, GF_FieldInfo *info)
{
	switch (node->sgprivate->tag) {
		...
		case TAG_SVG_conditional: return gf_svg_conditional_get_attribute(node, info);
		case TAG_SVG_cursorManager: return gf_svg_cursorManager_get_attribute(node, info);
		...
		case TAG_SVG_rectClip: return gf_svg_rectClip_get_attribute(node, info);
		case TAG_SVG_script: return gf_svg_script_get_attribute(node, info);
		case TAG_SVG_selector: return gf_svg_selector_get_attribute(node, info);
		case TAG_SVG_set: return gf_svg_set_get_attribute(node, info);
		case TAG_SVG_simpleLayout: return gf_svg_simpleLayout_get_attribute(node, info);
