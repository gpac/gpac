...
static Bool gf_sc_texture_enable_matte_texture(GF_Node *n)
{
	...
	if (! strcmp(action,"SCALE") || !strcmp(action,"BIAS") ) {
		...
		tx_bind(b_surf);
		GLTEXENV(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE,		COMBINE);
		GLTEXENV(GL_TEXTURE_ENV, COMBINE_RGB,			operand);
		GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB ,			GL_TEXTURE1);
		GLTEXENV(GL_TEXTURE_ENV, GL_OPERAND0_RGB,		GL_SRC_COLOR);
		GLTEXENV(GL_TEXTURE_ENV, SOURCE1_RGB,			GL_TEXTURE0);
		GLTEXENV(GL_TEXTURE_ENV, GL_OPERAND1_RGB,		GL_SRC_COLOR);
		GLTEXENV(GL_TEXTURE_ENV, COMBINE_ALPHA,		GL_REPLACE );
	...
	if (! strcmp(action,"CROSS_FADE")) {
		...
		if (a_surf) {
			...
			tx_bind(a_surf);
			GLTEXENV(GL_TEXTURE_ENV,GL_TEXTURE_ENV_MODE,COMBINE);
			GLTEXENV(GL_TEXTURE_ENV,COMBINE_RGB,INTERPOLATE );
			GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB , GL_TEXTURE1  );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND0_RGB,GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV, SOURCE1_RGB   , GL_TEXTURE2  );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND1_RGB,GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV,SOURCE2_RGB, GL_TEXTURE0  );
	...
	if (!strcmp(action,"REVEAL")) {
		...
		if (a_surf) {
			...
			GLTEXENV(GL_TEXTURE_ENV,GL_TEXTURE_ENV_MODE,COMBINE);
			GLTEXENV(GL_TEXTURE_ENV,COMBINE_RGB,INTERPOLATE );
			GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB , GL_TEXTURE0  );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND0_RGB,GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV, SOURCE1_RGB   , GL_TEXTURE2  );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND1_RGB,GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV,SOURCE2_RGB, GL_TEXTURE1 );
	...
	if (! strcmp(action,"INVERT")) {
		...
		tx_bind(b_surf);
		GLTEXENV(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE,	COMBINE);
		GLTEXENV(GL_TEXTURE_ENV, COMBINE_RGB,		GL_REPLACE );
		GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB,		GL_TEXTURE0  );
	...
	if (!strcmp(action,"MULTIPLY_ALPHA")) {
		...
		if (alpha_surf) {
			...
			GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB   , GL_TEXTURE0  );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND0_RGB,GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV,COMBINE_ALPHA,GL_MODULATE );
			GLTEXENV(GL_TEXTURE_ENV, GL_SOURCE1_ALPHA   , GL_TEXTURE1  );
	...
	if (! strcmp(action,"ADD")) {
		...
		if (a_surf) {
			...
			tx_bind(a_surf);
			GLTEXENV(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE,		COMBINE);
			GLTEXENV(GL_TEXTURE_ENV, COMBINE_RGB,			GL_ADD_SIGNED );
			GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB,			GL_TEXTURE0 );
			GLTEXENV(GL_TEXTURE_ENV, GL_OPERAND0_RGB,		GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV, SOURCE1_RGB,			GL_TEXTURE1 );
			GLTEXENV(GL_TEXTURE_ENV, GL_OPERAND1_RGB,		GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV, COMBINE_ALPHA,		GL_REPLACE );
			GLTEXENV(GL_TEXTURE_ENV, GL_SOURCE0_ALPHA,		GL_TEXTURE0  );
			GLTEXENV(GL_TEXTURE_ENV, GL_OPERAND0_ALPHA,	GL_SRC_ALPHA);
	...
	if (! strcmp(action,"ADD_SIGNED")) {
		...
		if (a_surf) {
			...
			tx_bind(a_surf);
			GLTEXENV(GL_TEXTURE_ENV,GL_TEXTURE_ENV_MODE,COMBINE);
			GLTEXENV(GL_TEXTURE_ENV,COMBINE_RGB,GL_ADD );
			GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB   , GL_TEXTURE0 );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND0_RGB,GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV,SOURCE1_RGB,GL_TEXTURE1 );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND1_RGB,GL_SRC_COLOR);
	...
	if (! strcmp(action,"SUBSTRACT")) {
		...
		if (a_surf) {
			...
			tx_bind(a_surf);
			GLTEXENV(GL_TEXTURE_ENV,GL_TEXTURE_ENV_MODE,COMBINE);
			GLTEXENV(GL_TEXTURE_ENV,COMBINE_RGB,GL_SUBTRACT);
			GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB   , GL_TEXTURE0 );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND0_RGB,GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV,SOURCE1_RGB,GL_TEXTURE1 );
			GLTEXENV(GL_TEXTURE_ENV,GL_OPERAND1_RGB,GL_SRC_COLOR);
	...
	if (! strcmp(action,"BLEND")) {
		...
		if (a_surf) {
			...
			GLTEXENV(GL_TEXTURE_ENV,GL_TEXTURE_ENV_MODE,GL_DECAL);
			GLTEXENV(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE,		COMBINE);
			GLTEXENV(GL_TEXTURE_ENV, COMBINE_RGB,			GL_MODULATE);
			GLTEXENV(GL_TEXTURE_ENV, SOURCE0_RGB,			GL_TEXTURE0 );
			GLTEXENV(GL_TEXTURE_ENV, GL_OPERAND0_RGB,		GL_SRC_COLOR);
			GLTEXENV(GL_TEXTURE_ENV, SOURCE1_RGB,			GL_TEXTURE1 );
			GLTEXENV(GL_TEXTURE_ENV, GL_OPERAND1_RGB,		GL_SRC_COLOR);
