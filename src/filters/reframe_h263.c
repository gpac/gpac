...
static const GF_FilterCapability H263DmxInputs[] =
{
	CAP_INC_STRING(GF_PROP_PID_MIME, "video/h263"),
	{},
...
GF_FilterRegister H263DmxRegister = {
	.name = "reframe_h263",
	.description = "H263 Demux",
	.private_size = sizeof(GF_H263DmxCtx),
	.args = H263DmxArgs,
	.finalize = h263dmx_finalize,
	INCAPS(H263DmxInputs),
	OUTCAPS(H263DmxOutputs),
