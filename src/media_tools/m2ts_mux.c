...
fprintf(stdout, "%d sections\n", nb_mpeg_sections);
fprintf(stdout, "%d pes (%d bytes)\n", nb_pes, pes_size);
fprintf(stdout, "%d padding bytes\n", pad_size);
}
