...
GF_GPACArg GPAC_Args[] = {
 ...
 GF_DEF_ARG("no-reservoir", NULL, "disables memory recycling for packets and properties.This uses much less memory but stresses the system memory allocator much more", NULL, NULL, GF_ARG_BOOL, GF_ARG_HINT_EXPERT|GF_ARG_SUBSYS_FILTERS),
