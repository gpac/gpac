...
struct __tag_compositor
{
	...
	*/
    ...
    /* necessary to tune 3D rendering engine for stereoscopic displays*/
    //maximum pixel disparity generated by hardware
    u32 disparity;
    //in pixels
    Fixed _3d_display_width;
    //nominal display viewing distance, in pixels
    Fixed view_distance;
    //half of inter-pupilary distance, in pixels
    Fixed e;
#endif
