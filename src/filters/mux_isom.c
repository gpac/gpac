...
GF_ENUM (GF_MP4MuxTagInjectionMode,
	TAG_NONE,
	TAG_STRICT,
	TAG_ALL,
);

GF_ENUM (GF_MP4MuxInbandParamSetMode,
	XPS_IB_NO = 0,
	XPS_IB_PPS,
	XPS_IB_ALL,
	XPS_IB_BOTH,
...
GF_ENUM (GF_MP4MuxFileStorageMode,
	MP4MX_MODE_INTER=0,
	MP4MX_MODE_FLAT,
...
GF_ENUM (GF_MP4MuxPsshStoreMode,
	MP4MX_PSSH_MOOV=0,
	MP4MX_PSSH_MOOF,
	MP4MX_PSSH_BOTH,
	MP4MX_PSSH_SKIP,
...
GF_ENUM (GF_MP4MuxCompositionOffsetMode,
	MP4MX_CT_AUTO,
	MP4MX_CT_EDIT=0,
	MP4MX_CT_NOEDIT,
	MP4MX_CT_NEGCTTS,
...
GF_ENUM (GF_MP4MuxTempStorageMode,
	MP4MX_VODCACHE_ON=0,
	MP4MX_VODCACHE_INSERT,
	MP4MX_VODCACHE_REPLACE,
);

GF_ENUM (GF_MP4MuxCMAFMode,
	MP4MX_CMAF_NO=0,
	MP4MX_CMAF_CMFC,
	MP4MX_CMAF_CMF2,
);

GF_ENUM (GF_MP4MuxChapterMode,
	MP4MX_CHAPM_OFF=0,
	MP4MX_CHAPM_TRACK,
	MP4MX_CHAPM_UDTA,
	MP4MX_CHAPM_BOTH,
